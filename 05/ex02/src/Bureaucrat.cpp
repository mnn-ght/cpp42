...
Bureaucrat &Bureaucrat::executeForm(const AForm &form)
{
	try {
		...
		std::cerr << "\e[1;31m" << this->_name << " couldn't execute '" << form.getName() << "' because its grade was too low." << "\e[0m" << std::endl;
	}
	return *this;
}
